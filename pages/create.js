...
export function PageName ({ formData, setFormData }) {
   const handlechange = (e) => setFormData({
    ...
    return (
         <div className='flex flex-col text-lg w-full justify-between mt-10'>
...
export function InfoBlock({step, nextFormStep, prevFormStep, formData, setFormData}) {
    ...
    return (<div className="flex flex-col h-full justify-between">
                {textBase[step]}
                <div className="flex flex-row w-full mt-24 mb-10">
...
export default function Create() {
  ...
  return (
    <main className='bg-white flex flex-col min-safe-h-screen mx-7 h-px justify-between'>
        <Slider step={formStep} setFormStep={setFormStep}/>
        <div className='flex flex-col rounded-xl h-4/6'>
